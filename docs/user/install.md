...
| Droid       | Install and authenticate the Factory Droid CLI, then enable it in T3 Code.                   |
...
[Antigravity](./providers-antigravity.md), and [Factory Droid](./providers-droid.md).
